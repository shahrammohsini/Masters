...
g = 9.8 # m/s^2
m = 0.1 # mass of pendelum in grams
M = 10 # mass of cart in grams
F = 0 # force input
theta = 183 #initial angle
...
while t < 15:
    ...
    Xcddot = (F + m*g*theta - m*L*thetadot*thetadot*theta)/(M + 2*m) #Linear but thetadot =/= 0
    ...
    thetaddot = (F + (M + m)*g*theta - m*L*thetadot*thetadot*theta)/(L*M) #Linear but thetadot =/= 0
