...
def finger_pos_update(voltage, prev_theta_D, prev_theta_P, prev_theta_M, time_Step, acumalating_time):
    ...
    if voltage >= 0:
        ...
        if theta_D_joint < max_D_joint_angle:
            ...
            theta_P_joint = prev_theta_P + time_Step*(-(0.9261)*prev_theta_P + 80.05*voltage)
...
async def main():
    ...
    try:
        ...
        #Save data
        save_data(time_data,motor_positions,theta_M_joints, theta_P_joints, theta_D_joints, pwms)
