...
plt.plot(sim_time, real_theta_D_joint, label='Real Theta D Joint', linestyle='--')
plt.xlabel('Time (s)')
...
plt.plot(sim_time, real_theta_P_joint, label='Real Theta P Joint', linestyle='--')
plt.xlabel('Time (s)')
...
plt.plot(sim_time, real_theta_M_joint, label='Real Theta M Joint', linestyle='--')
plt.xlabel('Time (s)')
