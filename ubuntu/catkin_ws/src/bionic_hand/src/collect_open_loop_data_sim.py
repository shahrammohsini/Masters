...
def save_data(times,theta_ms,theta_M_joints, theta_P_joints, theta_D_joints):
    ...
    with open('/home/shahram/Documents/GitHub/Masters/ubuntu/catkin_ws/src/bionic_hand/src/open_loop_data.csv', 'w', newline='') as file:
        writer = csv.writer(file)
        writer.writerow(["time", "theta_D_joint", "theta_P_joint" ,"theta_M_joint"])
        writer.writerows(data)
    print("data saved at /home/shahram/Documents/GitHub/Masters/ubuntu/catkin_ws/src/bionic_hand/src/open_loop_data.csv")
