...
def main():
    ...
    try:
        ...
        ser = serial.Serial('/dev/ttyUSB0', 57600)  # Replace 'COM3' with your Arduino's serial port
        ...
        if ser:
            ser.close()
        save_data_to_csv(data, '/home/shahram/Documents/GitHub/Masters/ubuntu/catkin_ws/src/bionic_hand/src/open_loop_data.csv')
