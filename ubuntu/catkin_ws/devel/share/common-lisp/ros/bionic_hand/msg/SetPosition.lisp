...
(cl:defmethod cl:initialize-instance :after ((m <SetPosition>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetPosition)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name bionic_hand-msg:<SetPosition> is deprecated: use bionic_hand-msg:SetPosition instead.")))
