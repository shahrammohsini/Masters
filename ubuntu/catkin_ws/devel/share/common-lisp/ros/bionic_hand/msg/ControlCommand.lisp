...
(cl:defmethod cl:initialize-instance :after ((m <ControlCommand>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ControlCommand)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name bionic_hand-msg:<ControlCommand> is deprecated: use bionic_hand-msg:ControlCommand instead.")))

(cl:ensure-generic-function 'PWM-val :lambda-list '(m))
(cl:defmethod PWM-val ((m <ControlCommand>))
