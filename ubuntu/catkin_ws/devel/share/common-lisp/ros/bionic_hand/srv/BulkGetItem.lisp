...
(cl:defmethod cl:initialize-instance :after ((m <BulkGetItem-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BulkGetItem-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name bionic_hand-srv:<BulkGetItem-request> is deprecated: use bionic_hand-srv:BulkGetItem-request instead.")))

(cl:ensure-generic-function 'id1-val :lambda-list '(m))
(cl:defmethod id1-val ((m <BulkGetItem-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bionic_hand-srv:id1-val is deprecated.  Use bionic_hand-srv:id1 instead.")
  (id1 m))

(cl:ensure-generic-function 'id2-val :lambda-list '(m))
(cl:defmethod id2-val ((m <BulkGetItem-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bionic_hand-srv:id2-val is deprecated.  Use bionic_hand-srv:id2 instead.")
  (id2 m))

(cl:ensure-generic-function 'item1-val :lambda-list '(m))
(cl:defmethod item1-val ((m <BulkGetItem-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bionic_hand-srv:item1-val is deprecated.  Use bionic_hand-srv:item1 instead.")
  (item1 m))

(cl:ensure-generic-function 'item2-val :lambda-list '(m))
(cl:defmethod item2-val ((m <BulkGetItem-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bionic_hand-srv:item2-val is deprecated.  Use bionic_hand-srv:item2 instead.")
  (item2 m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<BulkGetItem-request>)))
  ...
  "bionic_hand/BulkGetItemRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'BulkGetItem-request)))
  "Returns string type for a service object of type 'BulkGetItem-request"
  "bionic_hand/BulkGetItemRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <BulkGetItem-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BulkGetItem-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name bionic_hand-srv:<BulkGetItem-response> is deprecated: use bionic_hand-srv:BulkGetItem-response instead.")))

(cl:ensure-generic-function 'value1-val :lambda-list '(m))
(cl:defmethod value1-val ((m <BulkGetItem-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bionic_hand-srv:value1-val is deprecated.  Use bionic_hand-srv:value1 instead.")
  (value1 m))

(cl:ensure-generic-function 'value2-val :lambda-list '(m))
(cl:defmethod value2-val ((m <BulkGetItem-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bionic_hand-srv:value2-val is deprecated.  Use bionic_hand-srv:value2 instead.")
  (value2 m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<BulkGetItem-response>)))
  ...
  "bionic_hand/BulkGetItemResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'BulkGetItem-response)))
  "Returns string type for a service object of type 'BulkGetItem-response"
  "bionic_hand/BulkGetItemResponse")
