...
(cl:defmethod cl:initialize-instance :after ((m <SetPWM>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetPWM)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dynamixel_sdk_examples-msg:<SetPWM> is deprecated: use dynamixel_sdk_examples-msg:SetPWM instead.")))
...
(cl:defmethod pwm-val ((m <SetPWM>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dynamixel_sdk_examples-msg:pwm-val is deprecated.  Use dynamixel_sdk_examples-msg:pwm instead.")
  (pwm m))
