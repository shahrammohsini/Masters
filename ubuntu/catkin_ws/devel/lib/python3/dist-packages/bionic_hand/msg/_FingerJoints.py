...
"""autogenerated by genpy from bionic_hand/FingerJoints.msg. Do not edit."""
import codecs
import sys
...
class FingerJoints(genpy.Message):
  _md5sum = "87bf9b04d1a94d2eda566ee32685c210"
  _type = "bionic_hand/FingerJoints"
...
float64 theta_D"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(FingerJoints, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.theta_M, _x.theta_P, _x.theta_D,) = _get_struct_3d().unpack(str[start:end])
      return self
