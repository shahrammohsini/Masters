#ifndef _ROS_dynamixel_sdk_examples_SetPWM_h
#define _ROS_dynamixel_sdk_examples_SetPWM_h
...
namespace dynamixel_sdk_examples
{
  ...
  class SetPWM : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "dynamixel_sdk_examples/SetPWM"; };
