...
g = 9.8 # m/s^2
m = 1 # mass of pendelum in grams  use 1
M = 10 # mass of cart in grams     use 10
F = 0 # force input
...
Graph_Force = graph(title = 'Force vs Time', width = 400, height = 200, xtitle = "Time [s]", ytitle = "Force [N]", fast = False)
f_Force = gcurve(color=color.blue)
#graph of pendulum angle
...
while t < 40:
    ...
    F = P + I + D
    print(P, D, previous_error,dt,  error, F)
    ...
    #Graph
    f_Force.plot(t,-math.degrees(F)) #Plot theta in degrees
